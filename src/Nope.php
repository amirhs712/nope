 ...
 * @method $this file() The field under validation must be a successfully uploaded file.
 ...
 * @method $this image() The file under validation must be an image (jpeg, png, bmp, gif, svg, or webp)
 ...
 * @method $this integer() The field under validation must be an integer. This validation rule does not verify that the input is of the "integer" variable type, only that the input is a string or numeric value that contains an integer.
 ...
 * @method $this json() The field under validation must be a valid JSON string.
 ...
 * @method $this numeric() The field under validation must be numeric.
 ...
 * @method $this string() The field under validation must be a string. If you would like to allow the field to also be null, you should assign the nullable rule to the field.
...
class Nope
{
    ...
    public function __call($method, $arguments)
    {
        if (method_exists($this, $localMethod = $method . 'Handler')) {
            //This method has a custom handler.
            $this->$localMethod(...$arguments);
        } else if (isset($this->proxyRules[$method])) {
    ...
    protected function apply($name, $arguments)
    {
        $this->appliedRules[] = [
            'name' => $name,
            'arguments' => $arguments
